...
def parse_args(args):
    ...
    parser.add_argument(
        "--vision-tower", default="./weights/clip-vit-large-patch14", type=str
    )
    ...
    parser.add_argument("--weight", default="./Attn-7b/attn_pytorch_model.bin", type=str, required=True)
    parser.add_argument("--save_path", default="./ATTN-7B", type=str, required=True)
...
def main(args):
    ...
    num_added_tokens = tokenizer.add_tokens("[ATTN]")
