...
BLANK_QUESTION = """
Imagine you are driving in the provided image. The image shows your visual attention distribution. 
...
- Avoid assumptions about elements not visible in the image (e.g., side mirrors or rearview mirrors or dashboard or control panel).
"""
...
ANSWER_LIST = [
    ...
    "Sure, [ATTN].",
    "Sure, it is [ATTN].",
    "Sure, the attention distribution result is [ATTN].",
    "[ATTN].",
]
